...
filtered.df$is_50km_outlier <- ifelse(filtered.df$top_city_center_dist >= 50, 1, 0)
filtered.df$is_100km_outlier <- ifelse(filtered.df$top_city_center_dist >= 100, 1, 0)
